...
def evaluate(dataset, model, tokenizer, device, model_args, training_args, logger, output_name):
    dataloader = DataLoader(dataset, batch_size=1, shuffle=False, pin_memory=True, num_workers=2, drop_last=False, collate_fn=DataCollatorForGenerationDataset(tokenizer))
